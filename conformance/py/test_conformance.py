...
minrospy pip'ten gelir (pip install minrospy); yol hilesi yoktur.

Çalıştırma:
    python -m pytest conformance/py/test_conformance.py
"""
...
# conformance/vectors.json — bu dosya conformance/py/ altında, vectors bir üstte.
VECTORS_PATH = Path(__file__).resolve().parent.parent / "vectors.json"
